...
### 실행 순서표 (2026-09-19 · 파동 5 추가 2026-09-20)
...
24. **범위만 닫힘 (2026-09-20 · [[ADR-H071]] 결정 1·2) — 타입 전용 export 는 열린 채다** —
...
25. **07 이 구조적으로 빈손이고, 트리아지 오판정이 그 빈손을 한 번 더 부른다** — 클론 4런.
...
22. **런 내용과 무관한 gap 셋이 등급을 매번 깎는다** — 클론 4런. `stage_absent:e2e` ·
...
27. **04 의 `ambiguous → primary_role` 기본값이 틀린 역할을 먼저 가리킨다** — 클론 4런.
